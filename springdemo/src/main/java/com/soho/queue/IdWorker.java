...
public class IdWorker {
    ...
    /**
     * Start time cut (2020-05-03) 初始事件戳
     */
    private final long twepoch = 1588435200000L;

    /**
     * The number of bits occupied by the machine id：10bit的机器ID
     */
    ...
    /**
     * The number of bits the sequence occupies in id ：12bit的序列号
     */
    ...
    public static long initWorkerId() {
        ...
        long workId = ((ipAddressByteArray[ipAddressByteArray.length - 2] & 0B11) << Byte.SIZE) + (ipAddressByteArray[ipAddressByteArray.length - 1] & 0xFF);
